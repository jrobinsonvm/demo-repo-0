...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/jrobinsonvm/demo-repo-0.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "harbor.buildmodernapps.com/tap-demo/spring-sensors-0",
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->harbor.buildmodernap...(truncated)]
